...
public class LanguageProcessor {
    ...
    private static String CamelCaseRegex = "(?<=[a-z])(?=[A-Z])";
    private static Pattern CamelCasePattern = Pattern.compile(CamelCaseRegex);
    private static Pattern WordSplitPattern = Pattern.compile("\\b[a-zA-Z0-9]+\\b");
    ...
    public static List<String> normalizedWordList(String content) {
        final Matcher matcher = WordSplitPattern.matcher(content);
